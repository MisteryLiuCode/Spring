...
//        获取参数
        Object[] args = joinPoint.getArgs();
        System.out.println("切面类方法f2()-返回通知-方法名-" + signature.getName() + "结果:" + res);
    }
...
//        获取参数
        Object[] args = joinPoint.getArgs();
        System.out.println("切面类方法f3()-异常通知-方法名-" + signature.getName() + "异常信息:" + e);
    }
...
//        获取参数
    ...
    public void carRun(JoinPoint joinPoint) {
        Signature signature = joinPoint.getSignature();
        System.out.println("切面类方法-" + signature.getName());
//        joinPoint常用方法
//        获取去方法名
